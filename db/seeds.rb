...
Car.create(make: "Saab", model: "900", year: 1986, mileage: 300000, color: "red", description: "beautiful", is_gen_car: false)
Car.create(make: "Lotus", model: "Esprit", year: 1994, mileage: 21000, color: "white", description: "sexy", is_gen_car: false)
Car.create(make: "Tesla", model: "Y", year: 2021, mileage: 86, color: "white", description: "amazing", is_gen_car: false)
Car.create(make: "Hyundai", model: "Elantra", year: 2018, mileage: 28000, color: "silver", description: "meh", is_gen_car: false)
Car.create(make: "Toyota", model: "Previa", year: 1993, mileage: 60000, color: "purple", description: "sure why not", is_gen_car: false)
